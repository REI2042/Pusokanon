...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($staff && password_verify($password, $staff['staff_password'])) {
        if ($staff['status'] === 'ACTIVE') {
            ...
            if ($staff['userRole_id'] == 1 || $staff['userRole_id'] == 3 || $staff['userRole_id'] == 4 || $staff['userRole_id'] == 5 || $staff['userRole_id'] == 6|| $staff['userRole_id'] == 7 || $staff['userRole_id'] == 8) { // Admin roles
