  ...
  document.addEventListener('DOMContentLoaded', function() {
      ...
      clickableRows.forEach(row => {
          row.addEventListener('click', function() {
              ...
              fetch(`../adminbejo/phpConn/get_resident_info.php?id=${resId}`)
                          ...
                          Swal.fire({
                              ...
                              html: `
                                  ...
                                  <div class="row infos mx-0 my-3 text-start" style="padding: 3px;">
                                      ...
                                      <p class="age col-12 col-sm-6 mb-3"><strong>Age:</strong> ${data.age}</p>
                                      ...
                                      <p class="voter col-12 "><strong>Address:</strong> ${data.addr_sitio} Barangay Pusok, Lapu-Lapu City</p>
                                  </div>
                              `,
