                ...
                <div class="kuan">
                    ...
                    <div class="Pinned-Posts" id="pinnedPosts">
                        <h5 class="fw-bold d-flex align-items-center justify-content-between">
                                ...
                                <a href="#" id="show-all-pinned" class="d-flex justify-self-end text-black">
                                    <i class="bi bi-chevron-up ms-auto text-black"></i>
                                </a>
                        </h5>
                                ...
                                <a href="Res-view-Post.php?id=<?php echo $pinnedPosts[0]['post_id']; ?>&ref=forum">
                                    <div class="Pinned-Post my-2 mx-1 px-2 py-2">
                                        ...
                                        <div class="d-none d-md-block">
                                            ...
                                            <span class="pinned-reactions"><?php echo $pinnedPosts[0]['upvotes']; ?></span>
                                            <i class="fa-solid fa-thumbs-down pinned-reactions"></i>
                                            <span class="pinned-reactions"><?php echo $pinnedPosts[0]['downvotes']; ?></span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <?php else: ?>
                            <p class="no-pinned-message">There are no pinned barangay posts yet.</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
