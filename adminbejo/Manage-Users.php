                ...
                <div class="col-6 col-sm d-flex justify-content-center my-1 my-sm-0 align-self-center">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item <?php echo $ageRange == 'Under 18' ? 'active' : ''; ?>" href="?age_range=Under 18<?php echo isset($accountStatus) ? "&account_status=$accountStatus" : ""; echo isset($gender) ? "&gender=$gender" : ""; echo isset($sitio) ? "&sitio=$sitio" : ""; ?>">Under 18</a>
                ...
                <div class="col-6 col-sm d-flex justify-content-center my-1 my-sm-0 align-self-center">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item <?php echo $sitio == 'New Lipata' ? 'active' : ''; ?>" href="?sitio=New Lipata<?php echo isset($accountStatus) ? "&account_status=$accountStatus" : ""; echo isset($gender) ? "&gender=$gender" : ""; echo isset($ageRange) ? "&age_range=$ageRange" : ""; ?>">New Lipata</a>
                            ...
                            <a class="dropdown-item <?php echo $sitio == 'Sewage' ? 'active' : ''; ?>" href="?sitio=Sewage<?php echo isset($accountStatus) ? "&account_status=$accountStatus" : ""; echo isset($gender) ? "&gender=$gender" : ""; echo isset($ageRange) ? "&age_range=$ageRange" : ""; ?>">Sewage</a>
                        ...
                        <?php else: ?>
                            ...
                            ?>
                                <tr class="clickable-row" data-doc-id="<?php echo htmlspecialchars($user['res_ID']); ?>">
                                    ...
                                    <td class="tools">
                                    <button class="btn btn-secondary btn-sm view-btn" data-res-id="<?php echo htmlspecialchars($user['res_ID']); ?> " data-return-url="<?php echo urlencode($_SERVER['REQUEST_URI']); ?>" title="View Resident" data-bs-toggle="tooltip" data-bs-placement="left">
