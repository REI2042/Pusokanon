                        ...
                        <?php else: ?>
                            ...
                            ?>
                                <tr class="clickable-row" data-doc-id="<?php echo htmlspecialchars($user['res_ID']); ?>">
                                    ...
                                    <td class="tools">
                                    <button class="btn btn-secondary btn-sm view-btn" data-res-id="<?php echo htmlspecialchars($user['res_ID']); ?> " title="View Resident" data-bs-toggle="tooltip" data-bs-placement="left">
