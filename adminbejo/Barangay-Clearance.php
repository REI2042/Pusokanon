                                    ...
                                    <td>
                                        <div class="inline-tools">
                                            ...
                                            <form class="status-form" action="../db/updateStatus.php" method="POST">
                                                ...
                                                <button title="Dowload" type="submit" name="status" value="Processing" class="btn btn-sm <?= $pendings['stat'] == 'Processing' ? 'btn-secondary' : 'btn-secondary'; ?>"><i class="fa-solid fa-download"></i></button>
