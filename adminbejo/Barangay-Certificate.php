                                    ...
                                    <td>
                                        <div class="inline-tools">
                                            ...
                                            <form class="status-form" action="../db/updateStatus.php" method="POST">                                            
                                                ...
                                                <button title="Approve" type="submit" name="status" value="Processing" class="btn btn-sm <?= $processings['stat'] == 'Processing' ? 'btn-secondary' : 'btn-secondary'; ?>"><i class="fa-solid fa-download"></i></button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <div class="inline-tools">
                                            ...
                                            <form class="status-form" action="../db/updateStatus.php" method="POST">
                                                ...
                                                <button title="Approve" type="submit" name="status" value="Processing" class="btn btn-sm <?= $completed['stat'] == 'Processing' ? 'btn-secondary' : 'btn-secondary'; ?>"><i class="fa-solid fa-download"></i></button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
