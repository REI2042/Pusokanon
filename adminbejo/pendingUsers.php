...
// function handleApproveClick(userId) {
//     Swal.fire({
//         title: "Are you sure?",
...
//             window.location.href = "../ControllerAdmin/approveUsers.php?id=" + userId;
//         }
//     });
// }

// function handleXClick(userId) {
//     Swal.fire({
//         title: "Are you sure?",
//         text: "Do you want to disapprove this user?",
//         icon: "warning",
//         showCancelButton: true,
//         confirmButtonColor: "#3085d6",
//         cancelButtonColor: "#d33",
...
//     }).then((result) => {
//         if (result.isConfirmed) {
//             window.location.href = "../ControllerAdmin/unapproveUsers.php?id=" + userId;
//         }
//     });
// }
</script>
