            ...
            <div class="col-12 col-lg-9 col-xl-7">
                <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                    <div class="card-body p-3 p-md-4">
                        ...
                        <form id="staffAccountForm" method="POST" action="updateStaff.php">
                            <?php if (!empty($staff)): ?>
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3 ps-3 pe-1">
                                        <div data-mdb-input-init class="form-outline">
                                            <input type="text" id="firstName" name="firstName" class="form-control form-control-sm" autocomplete="off" value="<?= htmlspecialchars(decryptData($staffMember['staff_fname'])); ?>">
                                            <label class="form-label" for="firstName">First Name</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-3 ps-1 pe-1">
                                        <div data-mdb-input-init class="form-outline">
                                            <input type="text" id="lastName" name="lastName" class="form-control form-control-sm" autocomplete="off" value="<?= htmlspecialchars(decryptData($staffMember['staff_lname'])); ?>">
                                            <label class="form-label" for="lastName">Last Name</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-3 ps-1 pe-1">
                                        <div data-mdb-input-init class="form-outline">
                                            <input type="text" id="middleName" name="middleName" class="form-control form-control-sm" autocomplete="off" value="<?= htmlspecialchars(decryptData($staffMember['staff_midname'])); ?>">
                                    ...
                                    <div class="col-md-3 mb-3 ps-1">
                                        <div data-mdb-input-init class="form-outline">
                                            <select id="suffix" name="suffix" class="form-control form-control-sm">
                                                <option value="<?= htmlspecialchars($staffMember['staff_suffix']); ?>">Select Suffix</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 d-flex align-items-center">
                                        <div class="form-outline w-100">
                                            <input type="date" name="birthdayDate" class="form-control form-control-sm" autocomplete="off" id="birthdayDate" max="<?= date('Y-m-d'); ?>" value="<?= htmlspecialchars($staffMember['birth_date']); ?>" />
                                    ...
                                    <div class="col-md-6 mb-3 ps-0">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="femaleGender" value="Female" <?= htmlspecialchars($staffMember['gender']) == 'Female' ? 'checked' : '' ?> autocomplete="off" />
                                            <label class="form-check-label" for="femaleGender" style="font-size: 0.9rem;">Female</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="maleGender" value="Male" <?= htmlspecialchars($staffMember['gender']) == 'Male' ? 'checked' : '' ?> autocomplete="off" />
                                            <label class="form-check-label" for="maleGender" style="font-size: 0.9rem;">Male</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="otherGender" value="Other" <?= htmlspecialchars($staffMember['gender']) == 'Other' ? 'checked' : '' ?> autocomplete="off" />
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3 pb-2 pe-0">
                                        <div data-mdb-input-init class="form-outline">
                                            <input type="email" name="emailAddress" id="emailAddress" class="form-control form-control-sm" autocomplete="off" value="<?= htmlspecialchars(decryptData($staffMember['staff_email'])); ?>">
