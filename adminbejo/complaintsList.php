<?php
    ...
    $pendingComplaints = fetchListofComplaints($pdo, $pending_offset, $limit, null, $incidentPlace, 'Pending');
    $approvedComplaints = fetchListofComplaints($pdo, $approved_offset, $limit, null, $incidentPlace, 'Approved');
    $rejectedComplaints = fetchListofComplaints($pdo, $rejected_offset, $limit, null, $incidentPlace, 'Rejected');
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-start align-items-center">
                                                ...
                                                <button class="btn btn-warning btn-sm me-2" onclick="addRemarks('<?= htmlspecialchars($complaint['complaint_id']) ?>')">
                    ...
                    <nav id="pendingPagination" aria-label="Pending complaints pagination">
                        <ul class="pagination justify-content-center">
                            <?php if ($pendingPage > 1): ?>
                                <li class="page-item"><a class="page-link" href="?status=pending&pendingPage=<?php echo $pendingPage - 1; ?>">Prev</a></li>
                            <?php endif; ?>
                            <?php for ($i = 1; $i <= $num_pendingPage; $i++): ?>
                                <li class="page-item<?php if ($i == $pendingPage) echo ' active'; ?>"><a class="page-link" href="?status=pending&pendingPage=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                            <?php endfor; ?>
                            <?php if ($pendingPage < $num_pendingPage): ?>
                                <li class="page-item"><a class="page-link" href="?status=pending&pendingPage=<?php echo $pendingPage + 1; ?>">Next</a></li>
                            <?php endif; ?>
                        </ul>
                    </nav>
                </div>
